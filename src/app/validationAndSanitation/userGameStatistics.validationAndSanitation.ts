...
exports.validateUserGameStatisticsBodyPOST = [
    ...
    body('*.gamesPlayed.*.numHintsUsed', 'numHintsAskedFor is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numWrongCellsPlayed', 'numWrongCellsPlayed is not an integer').optional().isInt(),

    body('*.gamesPlayed.*.numHintsUsedPerStrategy.NAKED_SINGLE', 'numWrongCellsPlayed for NAKED_SINGLE is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.HIDDEN_SINGLE', 'numWrongCellsPlayed for HIDDEN_SINGLE is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.NAKED_PAIR', 'numWrongCellsPlayed for NAKED_PAIR is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.NAKED_TRIPLET', 'numWrongCellsPlayed for NAKED_TRIPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.NAKED_QUADRUPLET', 'numWrongCellsPlayed for NAKED_QUADRUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.NAKED_QUINTUPLET', 'numWrongCellsPlayed for NAKED_QUINTUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.NAKED_SEXTUPLET', 'numWrongCellsPlayed for NAKED_SEXTUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.NAKED_SEPTUPLET', 'numWrongCellsPlayed for NAKED_SEPTUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.NAKED_OCTUPLET', 'numWrongCellsPlayed for NAKED_OCTUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.HIDDEN_PAIR', 'numWrongCellsPlayed for HIDDEN_PAIR is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.HIDDEN_TRIPLET', 'numWrongCellsPlayed for HIDDEN_TRIPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.HIDDEN_QUADRUPLET', 'numWrongCellsPlayed for HIDDEN_QUADRUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.HIDDEN_QUINTUPLET', 'numWrongCellsPlayed for HIDDEN_QUINTUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.HIDDEN_SEXTUPLET', 'numWrongCellsPlayed for HIDDEN_SEXTUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.HIDDEN_SEPTUPLET', 'numWrongCellsPlayed for HIDDEN_SEPTUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.HIDDEN_OCTUPLET', 'numWrongCellsPlayed for HIDDEN_OCTUPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.POINTING_PAIR', 'numWrongCellsPlayed for POINTING_PAIR is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.POINTING_TRIPLET', 'numWrongCellsPlayed for POINTING_TRIPLET is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.BOX_LINE_REDUCTION', 'numWrongCellsPlayed for BOX_LINE_REDUCTION is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.X_WING', 'numWrongCellsPlayed for X_WING is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.SWORDFISH', 'numWrongCellsPlayed for SWORDFISH is not an integer').optional().isInt(),
    body('*.gamesPlayed.*.numHintsUsedPerStrategy.SINGLES_CHAINING', 'numWrongCellsPlayed for SINGLES_CHAINING is not an integer').optional().isInt(),
    ...
    body('*.strategiesLearned', 'Strategies learned array is not valid').optional().isArray().isIn(
        ["AMEND_NOTES", "SIMPLIFY_NOTES", "NAKED_SINGLE", "HIDDEN_SINGLE", "NAKED_PAIR", "NAKED_TRIPLET", "NAKED_QUADRUPLET", "NAKED_QUINTUPLET",
    ...
    body('*.numHintsUsed', 'numHintsAskedFor is not an integer').isInt(),
